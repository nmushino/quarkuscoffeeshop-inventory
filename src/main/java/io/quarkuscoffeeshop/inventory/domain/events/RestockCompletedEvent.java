...
public class RestockCompletedEvent implements RestockEvent, ExportedEvent<UUID, JsonNode> {
    ...
    public RestockCompletedEvent(UUID aggregateId, JsonNode jsonNode, Instant instant) {
